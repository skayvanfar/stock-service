...
public class StockControllerTest {
  ...
  public void getAllStocksBySize() throws Exception {
    ...
    RequestBuilder request = MockMvcRequestBuilders.get(baseUrl).accept(MediaType.APPLICATION_JSON);
  ...
  public void createStockAndReturn201HttpStatus() throws Exception {
    StockDTO stock =
        new StockDTO(
            10L, "BBT", BigDecimal.valueOf(37.55), Instant.parse("2020-12-22T14:42:09.951687Z"));
  ...
  public void updateStockAndReturn200HttpStatus() throws Exception {
    ...
    RequestBuilder patchRequest =
        MockMvcRequestBuilders.patch(baseUrl.concat("/1"))
  ...
  public void deleteStockAndReturn200HttpStatus() throws Exception {
    ...
    RequestBuilder deleteRequest =
        MockMvcRequestBuilders.delete(baseUrl.concat("/1")).accept(MediaType.APPLICATION_JSON);
